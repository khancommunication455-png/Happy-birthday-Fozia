      ...
      >
        ...
        <div className="flex-1 bg-white/60 backdrop-blur-lg flex flex-col pt-4 px-3 overflow-y-auto scrollbar-hide pb-20">
          <div className="text-center mb-4">
            ...
            <p className="text-[10px] text-gray-600 font-medium drop-shadow-sm">Fozia ✨</p>
          </div>
            ...
            {!isOpen ? (
                ...
                >
                    ...
                    <div className="relative w-full max-w-sm aspect-[4/3] bg-white/10 backdrop-blur-md shadow-2xl p-12 flex flex-col items-center justify-center border border-white/20 rounded-2xl">
                      ...
                      <h3 className="text-white font-serif text-2xl mt-4 drop-shadow-md">Fozia</h3>
            ...
            <div className="relative z-10 text-center max-w-4xl bg-black/20 backdrop-blur-sm border border-white/20 p-16 md:p-24 rounded-[3rem] shadow-[0_0_50px_rgba(0,0,0,0.5)] mx-4 w-full">
              {!response ? (
                ...
                >
                  ...
                  <h2 className="text-white text-7xl md:text-9xl font-script text-glow mb-8 tracking-tighter">My Brilliant Fozia</h2>
                  <p className="text-romantic-gold text-2xl font-serif italic tracking-widest uppercase opacity-60">Happy Birthday, Fozia. I appreciate you so much.</p>
                </motion.div>
              )}
            </div>
        </div>
...
const OutroMessage = () => (
    <div className="min-h-screen flex items-center justify-center p-8 bg-[#030014] relative">
        ...
        >
            ...
            <h3 className="text-white text-3xl font-serif italic mb-12 animate-pulse">See you in our next adventure, Fozia.</h3>
